...
function exp_BMP_Survey_Points_9rule0_eval_expression(context) {
    // BMP_Category = 'Agricultural'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('BMP_Category')  == 'Agricultural');
    } else {
        return (feature.get('BMP_Category')  == 'Agricultural');
    }
}
...
function exp_BMP_Survey_Points_9rule1_eval_expression(context) {
    // BMP_Category = 'Stormwater'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('BMP_Category')  == 'Stormwater');
    } else {
        return (feature.get('BMP_Category')  == 'Stormwater');
    }
}
...
function exp_BMP_Survey_Points_9rule2_eval_expression(context) {
    // Implemented = 'yes'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Implemented')  == 'yes');
    } else {
        return (feature.get('Implemented')  == 'yes');
    }
}