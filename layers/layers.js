...
function initializeUserLayers() {
    ...
    lyr_BMP_Survey_Points.set('fieldAliases', {'OBJECTID': 'OBJECTID', 'Landowner': 'Landowner', 'Unique_Landowner_ID': 'Unique_Landowner_ID', 'FarmerTracker': 'FarmerTracker', 'Impervious_Sq_Meters': 'Impervious_Sq_Meters', 'Area_Sq_Meters': 'Area_Sq_Meters', 'Prop_Impervious': 'Prop_Impervious', 'Universal_ID': 'Universal_ID', 'BMP_ID': 'BMP_ID', 'Source': 'Source', 'Source_Year': 'Source_Year', 'Project_Description': 'Project_Description', 'Local_ID': 'Local_ID', 'PM__acres_': 'PM__acres_', 'GW__acres_treated_': 'GW__acres_treated_', 'T_D__acres_treated_': 'T_D__acres_treated_', 'CSC__acres_planted_': 'CSC__acres_planted_', 'NT__acres_': 'NT__acres_', 'RB__linear_feet_': 'RB__linear_feet_', 'SR__linear_feet_': 'SR__linear_feet_', 'FR__linear_feet_': 'FR__linear_feet_', 'CC__acres_': 'CC__acres_', 'WR__acres_': 'WR__acres_', 'Other': 'Other', 'FarmerTracker_1': 'FarmerTracker_1', 'HUC12_Code': 'HUC12_Code', 'HUC12_Name': 'HUC12_Name', 'Priority_Subwatershed': 'Priority_Subwatershed', 'Municipality': 'Municipality', 'Crop_Summary': 'Crop_Summary', 'Cover_Crop_Summary': 'Cover_Crop_Summary', 'Cover_Crop_Classification': 'Cover_Crop_Classification', 'Outreach_Group': 'Outreach_Group', 'Catchment_IBI_Category': 'Catchment_IBI_Category', 'Priority_Score': 'Priority_Score', 'Project_Progress_Status': 'Project_Progress_Status', 'Address': 'Address', 'SRBC_Area_Order': 'SRBC_Area_Order', 'SRBC_Focus_Area_Name': 'SRBC_Focus_Area_Name', 'SRBC_Focus_Purpose': 'SRBC_Focus_Purpose', 'Recharge_Potential_Value': 'Recharge_Potential_Value', 'In_Critical_Recharge': 'In_Critical_Recharge', 'Shape_Length': 'Shape_Length', 'Shape_Area': 'Shape_Area', });
