...
// Function to initialize user-uploaded layers
function initializeUserLayers() {
    // Initialize Parcel Level Projects
    var format_Parcel_Level_Projects = new ol.format.GeoJSON();
    var features_Parcel_Level_Projects = format_Parcel_Level_Projects.readFeatures(json_Parcel_Level_Projects, 
                {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
    var jsonSource_Parcel_Level_Projects = new ol.source.Vector({
        attributions: ' ',
    });
    jsonSource_Parcel_Level_Projects.addFeatures(features_Parcel_Level_Projects);
    lyr_Parcel_Level_Projects = new ol.layer.Vector({
                    declutter: false,
                    source:jsonSource_Parcel_Level_Projects, 
                    style: style_Parcel_Level_Projects,
    ...
    var features_BMP_Survey_Points = format_BMP_Survey_Points.readFeatures(json_BMP_Survey_Points, 
                {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
    var jsonSource_BMP_Survey_Points = new ol.source.Vector({
        attributions: ' ',
    });
    jsonSource_BMP_Survey_Points.addFeatures(features_BMP_Survey_Points);
    lyr_BMP_Survey_Points = new ol.layer.Vector({
                    declutter: false,
                    source:jsonSource_BMP_Survey_Points, 
                    style: style_BMP_Survey_Points,
    ...
    layersList.forEach(function(group) {
        if (group.get('title') === 'Features') {
            featuresGroup = group;
        }
    });
    ...
    lyr_BMP_Survey_Points.set('fieldAliases', {'OBJECTID_1': 'OBJECTID_1', 'Address': 'Address', 'BMP_Category': 'BMP_Category', 'Base_SW_Score': 'Base_SW_Score', 'Catchment_IBI_Category': 'Catchment_IBI_Category', 'Final_SW_Score': 'Final_SW_Score', 'GlobalID_Text': 'GlobalID_Text', 'HUC12_Code': 'HUC12_Code', 'HUC12_Name': 'HUC12_Name', 'Impervious_Multiplier': 'Impervious_Multiplier', 'Impervious_Sq_Meters': 'Impervious_Sq_Meters', 'Implemented': 'Implemented', 'In_Critical_Recharge': 'In_Critical_Recharge', 'Landowner': 'Landowner', 'Municipality': 'Municipality', 'Notes': 'Notes', 'OBJECTID': 'OBJECTID', 'ParcelID_parcel': 'ParcelID_parcel', 'Preservation_Name': 'Preservation_Name', 'Preservation_Status': 'Preservation_Status', 'Preservation_Type': 'Preservation_Type', 'Priority_Subwatershed': 'Priority_Subwatershed', 'Project_Description': 'Project_Description', 'Project_Type': 'Project_Type', 'Prop_Area_Impervious': 'Prop_Area_Impervious', 'Prop_Impervious': 'Prop_Impervious', 'Recharge_Potential_Value': 'Recharge_Potential_Value', 'SRBC_Area_Order': 'SRBC_Area_Order', 'SRBC_Focus_Name': 'SRBC_Focus_Name', 'SRBC_Focus_Purpose': 'SRBC_Focus_Purpose', 'Smallshed': 'Smallshed', 'Source': 'Source', 'Source_Year': 'Source_Year', 'Unique_Landowner_ID': 'Unique_Landowner_ID', 'Universal_ID': 'Universal_ID', 'Visited': 'Visited', 'WAP_Num': 'WAP_Num', 'bmpNeeded': 'bmpNeeded', 'image_binary': 'image_binary', 'image_count': 'image_count', 'image_url': 'image_url', 'image_urls': 'image_urls', 'priority': 'priority', });
    
    lyr_Parcel_Level_Projects.set('fieldImages', {'OBJECTID': 'Hidden', 'Landowner_parcel': 'TextEdit', 'Unique_Landowner_ID': 'TextEdit', 'FarmerTracker': 'TextEdit', 'Impervious_Sq_Meters': 'Hidden', 'Area_Sq_Meters': 'Hidden', 'Prop_Impervious': 'Hidden', 'Universal_ID': 'TextEdit', 'BMP_ID': 'TextEdit', 'Source': 'TextEdit', 'Source_Year': 'TextEdit', 'Project_Description': 'TextEdit', 'Local_ID': 'TextEdit', 'Project_Types': 'TextEdit', 'PM__acres_': 'TextEdit', 'GW__acres_treated_': 'TextEdit', 'T_D__acres_treated_': 'TextEdit', 'CSC__acres_planted_': 'TextEdit', 'NT__acres_': 'TextEdit', 'RB__linear_feet_': 'TextEdit', 'SR__linear_feet_': 'TextEdit', 'FR__linear_feet_': 'TextEdit', 'CC__acres_': 'TextEdit', 'WR__acres_': 'TextEdit', 'Other': 'TextEdit', 'FarmerTracker_1': 'TextEdit', 'HUC12_Code': 'Hidden', 'HUC12_Name': 'Hidden', 'Priority_Subwatershed': 'TextEdit', 'Municipality': 'TextEdit', 'Crop_Summary': 'Hidden', 'Cover_Crop_Summary': 'Hidden', 'Cover_Crop_Classification': 'Hidden', 'Outreach_Group': 'Hidden', 'Catchment_IBI_Category': 'TextEdit', 'Priority_Score': 'TextEdit', 'Project_Progress_Status': 'Hidden', 'Address_parcel': 'TextEdit', 'Address_parcel_1': 'Hidden', 'SRBC_Area_Order': 'Hidden', 'SRBC_Focus_Area_Name': 'TextEdit', 'SRBC_Focus_Purpose': 'Hidden', 'Recharge_Potential_Value': 'TextEdit', 'In_Critical_Recharge': 'TextEdit', 'Preservation_Management': 'TextEdit', 'Preservation_Type': 'TextEdit', 'Preservation_Name': 'TextEdit', 'Shape_Length': 'Hidden', 'Shape_Area': 'Hidden', });
    lyr_BMP_Survey_Points.set('fieldImages', {'OBJECTID_1': 'Hidden', 'Address': 'TextEdit', 'BMP_Category': 'TextEdit', 'Base_SW_Score': 'TextEdit', 'Catchment_IBI_Category': 'TextEdit', 'Final_SW_Score': 'TextEdit', 'GlobalID_Text': 'Hidden', 'HUC12_Code': 'Hidden', 'HUC12_Name': 'TextEdit', 'Impervious_Multiplier': 'Hidden', 'Impervious_Sq_Meters': 'Hidden', 'Implemented': 'TextEdit', 'In_Critical_Recharge': 'TextEdit', 'Landowner': 'TextEdit', 'Municipality': 'TextEdit', 'Notes': 'TextEdit', 'OBJECTID': 'Hidden', 'ParcelID_parcel': 'Hidden', 'Preservation_Name': 'TextEdit', 'Preservation_Status': 'TextEdit', 'Preservation_Type': 'TextEdit', 'Priority_Subwatershed': 'TextEdit', 'Project_Description': 'TextEdit', 'Project_Type': 'TextEdit', 'Prop_Area_Impervious': 'Hidden', 'Prop_Impervious': 'Hidden', 'Recharge_Potential_Value': 'TextEdit', 'SRBC_Area_Order': 'Hidden', 'SRBC_Focus_Name': 'TextEdit', 'SRBC_Focus_Purpose': 'TextEdit', 'Smallshed': 'TextEdit', 'Source': 'TextEdit', 'Source_Year': 'TextEdit', 'Unique_Landowner_ID': 'TextEdit', 'Universal_ID': 'TextEdit', 'Visited': 'Hidden', 'WAP_Num': 'TextEdit', 'bmpNeeded': 'TextEdit', 'image_binary': 'Hidden', 'image_count': 'Hidden', 'image_url': 'Hidden', 'image_urls': 'Hidden', 'priority': 'TextEdit', });
    lyr_BMP_Survey_Points.set('fieldImages', {'OBJECTID': 'Hidden', 'Landowner': 'TextEdit', 'Unique_Landowner_ID': 'TextEdit', 'FarmerTracker': 'TextEdit', 'Impervious_Sq_Meters': 'Hidden', 'Area_Sq_Meters': 'Hidden', 'Prop_Impervious': 'Hidden', 'Universal_ID': 'TextEdit', 'BMP_ID': 'TextEdit', 'Source': 'TextEdit', 'Source_Year': 'TextEdit', 'Project_Description': 'TextEdit', 'Local_ID': 'TextEdit', 'PM__acres_': 'TextEdit', 'GW__acres_treated_': 'TextEdit', 'T_D__acres_treated_': 'TextEdit', 'CSC__acres_planted_': 'TextEdit', 'NT__acres_': 'TextEdit', 'RB__linear_feet_': 'TextEdit', 'SR__linear_feet_': 'TextEdit', 'FR__linear_feet_': 'TextEdit', 'CC__acres_': 'TextEdit', 'WR__acres_': 'TextEdit', 'Other': 'TextEdit', 'FarmerTracker_1': 'TextEdit', 'HUC12_Code': 'Hidden', 'HUC12_Name': 'Hidden', 'Priority_Subwatershed': 'TextEdit', 'Municipality': 'TextEdit', 'Crop_Summary': 'Hidden', 'Cover_Crop_Summary': 'Hidden', 'Cover_Crop_Classification': 'Hidden', 'Outreach_Group': 'Hidden', 'Catchment_IBI_Category': 'TextEdit', 'Priority_Score': 'TextEdit', 'Project_Progress_Status': 'Hidden', 'Address': 'TextEdit', 'SRBC_Area_Order': 'Hidden', 'SRBC_Focus_Name': 'TextEdit', 'SRBC_Focus_Purpose': 'Hidden', 'Recharge_Potential_Value': 'TextEdit', 'In_Critical_Recharge': 'TextEdit', 'Shape_Length': 'Hidden', 'Shape_Area': 'Hidden', });
    
    lyr_Parcel_Level_Projects.set('fieldLabels', {'OBJECTID': 'hidden field', 'Landowner_parcel': 'inline label - visible with data', 'Unique_Landowner_ID': 'inline label - visible with data', 'FarmerTracker': 'inline label - visible with data', 'Impervious_Sq_Meters': 'hidden field', 'Area_Sq_Meters': 'hidden field', 'Prop_Impervious': 'hidden field', 'Universal_ID': 'inline label - visible with data', 'BMP_ID': 'inline label - visible with data', 'Source': 'inline label - visible with data', 'Source_Year': 'inline label - visible with data', 'Project_Description': 'inline label - visible with data', 'Local_ID': 'inline label - visible with data', 'Project_Types': 'inline label - visible with data', 'PM__acres_': 'inline label - visible with data', 'GW__acres_treated_': 'inline label - visible with data', 'T_D__acres_treated_': 'inline label - visible with data', 'CSC__acres_planted_': 'inline label - visible with data', 'NT__acres_': 'inline label - visible with data', 'RB__linear_feet_': 'inline label - visible with data', 'SR__linear_feet_': 'inline label - visible with data', 'FR__linear_feet_': 'inline label - visible with data', 'CC__acres_': 'inline label - visible with data', 'WR__acres_': 'inline label - visible with data', 'Other': 'inline label - visible with data', 'FarmerTracker_1': 'inline label - visible with data', 'HUC12_Code': 'hidden field', 'HUC12_Name': 'hidden field', 'Priority_Subwatershed': 'inline label - visible with data', 'Municipality': 'inline label - visible with data', 'Crop_Summary': 'hidden field', 'Cover_Crop_Summary': 'hidden field', 'Cover_Crop_Classification': 'hidden field', 'Outreach_Group': 'hidden field', 'Catchment_IBI_Category': 'inline label - visible with data', 'Priority_Score': 'inline label - visible with data', 'Project_Progress_Status': 'hidden field', 'Address_parcel': 'inline label - visible with data', 'Address_parcel_1': 'hidden field', 'SRBC_Area_Order': 'hidden field', 'SRBC_Focus_Area_Name': 'inline label - visible with data', 'SRBC_Focus_Purpose': 'hidden field', 'Recharge_Potential_Value': 'inline label - visible with data', 'In_Critical_Recharge': 'inline label - visible with data', 'Preservation_Management': 'inline label - visible with data', 'Preservation_Type': 'inline label - visible with data', 'Preservation_Name': 'inline label - visible with data', 'Shape_Length': 'hidden field', 'Shape_Area': 'hidden field', });
    lyr_BMP_Survey_Points.set('fieldLabels', {'OBJECTID': 'hidden field', 'Landowner': 'inline label - visible with data', 'Unique_Landowner_ID': 'inline label - visible with data', 'FarmerTracker': 'inline label - visible with data', 'Impervious_Sq_Meters': 'hidden field', 'Area_Sq_Meters': 'hidden field', 'Prop_Impervious': 'hidden field', 'Universal_ID': 'inline label - visible with data', 'BMP_ID': 'inline label - visible with data', 'Source': 'inline label - visible with data', 'Source_Year': 'inline label - visible with data', 'Project_Description': 'inline label - visible with data', 'Local_ID': 'inline label - visible with data', 'PM__acres_': 'inline label - visible with data', 'GW__acres_treated_': 'inline label - visible with data', 'T_D__acres_treated_': 'inline label - visible with data', 'CSC__acres_planted_': 'inline label - visible with data', 'NT__acres_': 'inline label - visible with data', 'RB__linear_feet_': 'inline label - visible with data', 'SR__linear_feet_': 'inline label - visible with data', 'FR__linear_feet_': 'inline label - visible with data', 'CC__acres_': 'inline label - visible with data', 'WR__acres_': 'inline label - visible with data', 'Other': 'inline label - visible with data', 'FarmerTracker_1': 'inline label - visible with data', 'HUC12_Code': 'hidden field', 'HUC12_Name': 'hidden field', 'Priority_Subwatershed': 'inline label - visible with data', 'Municipality': 'inline label - visible with data', 'Crop_Summary': 'hidden field', 'Cover_Crop_Summary': 'hidden field', 'Cover_Crop_Classification': 'hidden field', 'Outreach_Group': 'hidden field', 'Catchment_IBI_Category': 'inline label - visible with data', 'Priority_Score': 'inline label - visible with data', 'Project_Progress_Status': 'hidden field', 'Address': 'inline label - visible with data', 'SRBC_Area_Order': 'hidden field', 'SRBC_Focus_Area_Name': 'inline label - visible with data', 'SRBC_Focus_Purpose': 'hidden field', 'Recharge_Potential_Value': 'inline label - visible with data', 'In_Critical_Recharge': 'inline label - visible with data', 'Shape_Length': 'hidden field', 'Shape_Area': 'hidden field', });
    
    lyr_Parcel_Level_Projects.setVisible(true);
    lyr_BMP_Survey_Points.setVisible(true);
    
    // Add visibility change listeners to the newly created layers
    lyr_BMP_Survey_Points.on('change:visible', function() {
        if (typeof window.updateFeatureCounts === 'function') {
            window.updateFeatureCounts();
        }
    });
    
    lyr_Parcel_Level_Projects.on('change:visible', function() {
        if (typeof window.updateFeatureCounts === 'function') {
            window.updateFeatureCounts();
        }
    });
    
    // Trigger feature counter update after layers are loaded
    if (typeof window.updateFeatureCounts === 'function') {
